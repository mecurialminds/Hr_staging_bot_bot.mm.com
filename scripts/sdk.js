...
function WebLiveChatListener() {
	...
	this.createBox = function() {
		...
		if (this.background != null) {
			...
			hidden = "visible";
			border = "border:0px;border-style:solid;border-color:#008269;";
		}
		if (this.color != null) {
			buttonstyle = "background-color:#008269;";
		}
		if (this.hoverColor != null) {
			buttonHoverStyle = "background-color:background-color:#008269;";
		}
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "box { position:fixed;" + boxloc + ";z-index:152;margin:2px;display:none;" + border + " border-radius: 10px;}\n"
				...
				+ "." + this.prefix + "contactconnect { margin:4px;padding:8px;color:white;text-decoration:none;border-radius: 8px;" + buttonstyle + " }\n"
				...
				+ "." + this.prefix + "chat-1-div { " + "max-width: 280px;" + "}\n"
				+ "." + this.prefix + "chat-2-div { " + "max-width: 280px;" + "}\n"
				+ "." + this.prefix + "online-div { " + "width:360px;" + " overflow-x: auto; overflow-y: hidden; white-space: nowrap; }\n"
				+ "." + this.prefix + "scroller { overflow-x:hidden;" + "height:370px;" + "width:358px;" + " }\n"
		...
		if (this.version < 6.0 || this.prefix != "botplatformchat") {
			html = html
						...
						+ "." + this.prefix + "box:hover { border:1px;border-style:solid;border-color:#008269; }\n"
						+ "." + this.prefix + "box:hover ." + this.prefix + "boxmenu { visibility:visible; }\n"
		...
		html = html
			...
			+ "<div id='" + this.prefix + "box' class='" + this.prefix + "box' " + backgroundstyle + ">"
				+ "<div class='" + this.prefix + "boxmenu'>"
					...
					+ "<span style='float:right'><a id='" + this.prefix + "boxmin' class='" + this.prefix + "boxmin' onclick='return false;' href='#'><img src='images/minimize.png'></a>";
					if (this.showBoxmax) {
						html = html + "<a id='" + this.prefix + "boxmax' class='" + this.prefix + "boxmax' onclick='return false;' href='#'><img src='images/maximize.png'></a></span><br/>";
					} else {
						html = html + "</span><br/>";
					}	
				html = html + "</div>";
		...
		html = html
			...
			if (this.showMenubar) {
				...
				html = html
					...
					+ "</table>\n"
					+ "</div>\n"
					+ "<img class='" + this.prefix + "toolbar' src='images/menu.png'>\n"
					+ "</span>\n"
					+ "</div>\n"
		    		+ "</span></td>\n";
			}
		...
		if (this.promptContactInfo) {
			html = html
				+ "<div id='" + this.prefix + "contactinfo' class='" + this.prefix + "box' " + backgroundstyle + ">"
					+ "<div class='" + this.prefix + "boxmenu'>"
						+ "<span style='float:right'><a id='" + this.prefix + "contactboxmin' class='" + this.prefix + "contactboxmin' onclick='return false;' href='#'><img src='images/minimize.png'></a>"
					+ "</div>\n"
		...
		if (this.promptEmailChatLog) {
			html = html
				+ "<div id='" + this.prefix + "emailchatlogdialog' class='" + this.prefix + "box' " + backgroundstyle + ">"
					+ "<div class='" + this.prefix + "boxmenu'>"
						+ "<span style='float:right'><a id='" + this.prefix + "emailchatlogdialogmin' class='" + this.prefix + "boxmin' onclick='return false;' href='#'><img src='images/minimize.png'></a>"
					+ "</div>\n"
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				...
				+ "." + this.prefix + "chatchat-1-div { " + "max-width: 280px;" + "}\n"
				+ "." + this.prefix + "chatchat-2-div { " + "max-width: 280px;" + "}\n"
				+ (this.forceStyles ? "#" : ".") + this.prefix + "chat { width:99%;min-height:22px; }\n"
				+ "." + this.prefix + "box:hover ." + this.prefix + "boxmenu { visibility:visible; }\n";
		if (this.version < 6.0 || this.prefix != "botplatform") {
			html = html
...
function WebAvatar() {
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "avatarbox { position:fixed;bottom:10px;left:10px;z-index:152;margin:2px;" + border + " border-radius: 10px;}\n"
				+ "." + this.prefix + "avatarbox:hover { border:0px;border-color:#008269; }\n"
